<?php
	...
	$datetime = date('อัพเดทเมื่อ : เวลา G:i:s วันที่ d/m/Y');	$strSQL = "SELECT * FROM member WHERE id BETWEEN 115 and 154";
	...
	$section->addText('รายชื่อนักเรียนชั้นมัธยมศึกษาปีที่   6 / 4 ', 'rStyle', 'pStyle');
...
header("Content-Disposition: attachment; filename=ข้อมูลมหาลัยราชวิทย์_๔๘_ห้อง_4.docx");
