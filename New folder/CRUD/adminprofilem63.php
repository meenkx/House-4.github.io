...
<?php 
include "header.php";
include "alertsm63.php";
include "connect.php"; 

$sql = mysql_query("SELECT id,Username,Name,House,Lastname,University,Faculty ,Note FROM member WHERE id BETWEEN 073 AND 114 ");
		...
		<table class="table table-hover table-bordered">
			...
			<?php $no=1; while ($row = mysql_fetch_array($sql)) { ?>
				<tr>
					...
					<td align="center">
						<a href="admineditm63.php?id=<?php echo $row['id']; ?>">update</a> 
					</td>
				</tr>
			<?php $no++; } ?>	
			</tbody>
