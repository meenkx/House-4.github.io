...
$sql = mysql_query("SELECT id,Username,Name,House,Lastname,University,Faculty ,Note FROM member WHERE id BETWEEN 001 AND 036 ");
		...
		<table class="table table-hover table-bordered">
			...
			<?php $no=1; while ($row = mysql_fetch_array($sql)) { ?>
				<tr>
					...
					<td align="center">
						<a href="admineditm61.php?id=<?php echo $row['id']; ?>">update</a> 
					</td>
				</tr>
			<?php $no++; } ?>	
			</tbody>
