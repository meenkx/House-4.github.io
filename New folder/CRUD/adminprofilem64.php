...
<?php 
include "header.php";
include "alertsm64.php";
include "connect.php"; 

$sql = mysql_query("SELECT id,Username,Name,House,Lastname,University,Faculty ,Note FROM member WHERE id BETWEEN 115 AND 154 ");
		...
		<table class="table table-hover table-bordered">
			...
			<?php $no=1; while ($row = mysql_fetch_array($sql)) { ?>
				<tr>
					...
					<td align="center">
						<a href="admineditm64.php?id=<?php echo $row['id']; ?>">update</a> 
					</td>
				</tr>
			<?php $no++; } ?>	
			</tbody>
