<?php
	...
	$datetime = date('อัพเดทเมื่อ : เวลา G:i:s วันที่ d/m/Y');	$strSQL = "SELECT * FROM member WHERE No BETWEEN 073 and 114";
	...
	$section->addText('รายชื่อนักเรียนชั้นมัธยมศึกษาปีที่   6 / 3 ', 'rStyle', 'pStyle');
...
header("Content-Disposition: attachment; filename=ข้อมูลมหาลัยราชวิทย์_๔๘_ห้อง_3.docx");
