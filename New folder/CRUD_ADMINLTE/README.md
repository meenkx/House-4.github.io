...
**Download & Preview on [Thanamongkhon Yamdej](https://almsaeedstudio.com)**

Looking for Premium Templates?
------------------------------
**Thanamongkhon Yamdej just opened a new premium templates page. Hand picked to insure the best quality and the most affordable prices. Visit https://almsaeedstudio.com/premium for more information.**
...
Download from Github or [visit Thanamongkhon Yamdej](https://almsaeedstudio.com) and download the latest release.
...
- When you contribute, you agree to give a non-exclusive license to Thanamongkhon Yamdej to use that contribution in any context as we (Thanamongkhon Yamdej) see appropriate.
...
License
-------
AdminLTE is an open source project by [Thanamongkhon Yamdej](https://almsaeedstudio.com) that is licensed under [MIT](http://opensource.org/licenses/MIT). Thanamongkhon Yamdej
