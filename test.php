<?php
	...
	$userDetails=$userClass->userDetails($session_No);
?>
<!-- html code -->
<!doctype html>
<html lang="en">
	...
	<div class="container">
        <div class="navbar-header">
	    	...
	    	<a href="http://www.creative-tim.com">
	        	<div class="logo-container">
	                ...
	                <div class="brand">
	                    สวัสดีครับ <?php echo $userDetails->Name; ?>
	                </div>
	    ...
	    <div class="collapse navbar-collapse" id="navigation-index">
	    	<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<!-- <a rel="tooltip" title="Logout" data-placement="bottom" href="php/logout.php" target="_top" class="btn btn-white btn-simple btn-just-icon">
						<button class="btn btn-primary btn-round">Logout</button>
					</a> -->
...
<div class="wrapper">
	...
	<div class="main main-raised">
		...
		<div class="section section-examples">
	        <div class="container-flNo text-center">
	            <div class="row">
	                <div class="col-md-6">
